...
export const generatorSchema = z.object({
  ...
  runningHours: z
    .number()
    .min(0, "Les heures ne peuvent pas etre negatives")
    .optional(),

  lastMaintenanceHours: z.number().min(0).optional(),
  lastMaintenanceDate: z.string().optional(), // ISO date string
...
export const rectifierSchema = z
  ...
  .refine(
    // modulesOk ne peut pas depasser modulesTotal
    (data) => {
...
export const earthingSchema = z.object({
  resistance: z
    .number()
    .min(0, "La resistance ne peut pas etre negative")
    .optional(),
